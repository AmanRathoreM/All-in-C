...
# These tutorials are watched from [**_Code With Harry_**](https://www.youtube.com/channel/UCeVMnSShP_Iviwkknt83cww "Clike here to checkout his YouTube channel") YouTube channel from [**_C Tutorials Playlist_**](https://youtube.com/playlist?list=PLu0W_9lII9aiXlHcLx-mDH1Qul38wD3aR "Clike here to check out his C Tutorials Playlist")
...
### [**_Click me_**](tutorial_60.c "Clike here to see full file") to see full file of tutorial_60.c
...
## **_tutorial_63_exercise_11.c_**

### [**_Click me_**](tutorial_63_exercise_11.c "Clike here to see full file") to see full file of tutorial_63_exercise_11.c
...
### [**_Click me_**](tutorial_64.c "Clike here to see full file") to see full file of tutorial_64.c
...
## **_tutorial_66_exercise_12.c_**

### [**_Click me_**](tutorial_66_exercise_12.c "Clike here to see full file") to see full file of tutorial_66_exercise_12.c
...
### [**_Click me_**](tutorial_67.c "Clike here to see full file") to see full file of tutorial_67.c
...
### [**_Click me_**](tutorial_68.c "Clike here to see full file") to see full file of tutorial_68.c
...
## **_tutorial_70_exercise_13.c_**

### [**_Click me_**](tutorial_70_exercise_13.c "Clike here to see full file") to see full file of tutorial_70_exercise_13.c
...
### [**_Click me_**](tutorial_72.c "Clike here to see full file") to see full file of tutorial_72.c
...
### [**_Click me_**](tutorial_73.c "Clike here to see full file") to see full file of tutorial_73.c
...
## **_tutorial_74_exercise_14.c_**

### [**_Click me_**](tutorial_74_exercise_14.c "Clike here to see full file") to see full file of tutorial_74_exercise_14.c
...
### [**_Click me_**](tutorial_75.c "Clike here to see full file") to see full file of tutorial_75.c

```c
// Date 10-07-2021

//* use task manager to see memory usage of memory leak
//* use task manager to see memory usage of memory leak
//* use task manager to see memory usage of memory leak
//* use task manager to see memory usage of memory leak
//* use task manager to see memory usage of memory leak
